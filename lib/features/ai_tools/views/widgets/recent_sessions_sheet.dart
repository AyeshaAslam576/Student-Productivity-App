...
class RecentSessionsSheet extends StatelessWidget {
      ...
      builder: (_, controller) => Container(
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text('Recent Sessions', style: context.text.h4),
                  const Spacer(),
            ...
            Divider(color: colors.surfaceBorder, height: 14),
            Expanded(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        _typeColor(session.type, context).withOpacity(0.12),
                                    borderRadius: BorderRadius.circular(10),
                                  ),
                                  child: Icon(
                                    _typeIcon(session.type),
                                    color: _typeColor(session.type, context),
                                    size: 18,
                                  ),
                                ),
  ...
  Color _typeColor(SessionType type, BuildContext context) {
    final colors = context.colors;
    return switch (type) {
      SessionType.summarizer => colors.accent,
      SessionType.grammar => colors.success,
      SessionType.chatbot => colors.info,
      SessionType.tts => colors.warning,
    };
  }
